// Supabase DataSource - Original cloud implementation
...
// Storage helpers for browser fallback (ideas, transactions)
const STORAGE_KEYS = {
  ideas: 'optimai_ideas',
